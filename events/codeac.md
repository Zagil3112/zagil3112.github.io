...
<div class="columns is-multiline is-centered is-vcentered">
  <div class="column is-5">
    <header class="card-header">
      <p class="card-header-title is-centered"><big>Teniente Coronel Sonia Rincón</big></p>
    </header>
    <div class="card">
      <div class="card-image">
        <figure class="fill">
          <img src="../icons/user.jpg" width="75%" alt="Expositor">
        </figure>
      </div>
  ...
  <div class="column is-5">
    <header class="card-header">
      <p class="card-header-title is-centered"><big>Jimmy Florez</big></p>
    </header>
    <div class="card">
      <div class="card-image">
        <figure class="fill">
...
<div class="columns is-multiline is-centered is-vcentered">
  <div class="column is-5">
    <header class="card-header">
      <p class="card-header-title is-centered"><big>Ing. Oscar Ojeda</big></p>
    </header>
    <div class="card">
      <div class="card-image">
        <figure class="fill">
      ...
      <div class="card-content">
        Ingeniero Mecánico de la Universidad Nacional de Colombia con Maestría en Ingeniería Aeroespacial de la Universidad de Purdue, director de la Fundación Cydonia.
      </div>
    </div>
  </div>
  <div class="column is-5">
    <header class="card-header">
      <p class="card-header-title is-centered"><big>Ing. Camilo Vergara</big></p>
    </header>
    <div class="card">
      <div class="card-image">
        <figure class="fill">
      ...
      <div class="card-content">
        Presidente para Colombia de la Sociedad de Sistemas Aeroespaciales y Electrónicos (AESS) de la Rama IEEE, vicepresidente de Relaciones Institucionales de la Corporación Científica del Sector Aeroespacial (COCSA).
      </div>
    </div>
  </div>
</div>
...
<div class="columns is-multiline is-centered is-vcentered">
  <div class="column is-5">
    <header class="card-header">
      <p class="card-header-title is-centered"><big>MSc. María A. Corzo</big></p>
    </header>
    <div class="card">
      <div class="card-image">
        <figure class="fill">
      ...
      <div class="card-content">
        Médico cirujano de la Universidad Militar Nueva Granada, magister en Fisiología de la Universidad Nacional de Colombia y Magister en Fisiología y Salud Espacial del King's College London.
      </div>
    </div>
  </div>
  <div class="column is-5">
    <header class="card-header">
      <p class="card-header-title is-centered"><big>Juan C. Palacios</big></p>
    </header>
    <div class="card">
      <div class="card-image">
        <figure class="fill">
...
<div class="columns is-multiline is-centered is-vcentered">
  <div class="column is-5">
    <header class="card-header is-centered">
      <p class="card-header-title is-centered"><big>Coronel (r) Raúl E. Gutiérrez G.</big></p>
    </header>
    <div class="card">
      <div class="card-image">
        <figure class="fill">
      ...
      <div class="card-content">
        Ex-piloto militar de la FAC, ex-director del Museo Aeroespacial Colombiano, director del Centro de Investigación en Tecnologías Aeroespaciales, gerente del Clúster Aeroespacial Valle del Cauca y Jefe de Asuntos Espaciales, presidente y CEO del National Space Society Colombia (NSSC).
      </div>
    </div>
  </div>
</div> -->
